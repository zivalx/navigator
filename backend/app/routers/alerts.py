...
async def update_alert(
    ...
    """Edit rule/threshold/note, or reactivate an alert.

    Setting isActive=true clears triggered_at/triggered_price/acknowledged_at
    so the alert can fire again (one-shot re-arm)."""
